# [Source][@/BashutilsUtilLoggingsh]|[Zotero][z@/BashutilsUtilLoggingsh]
...
# References:
# [@/BashutilsUtilLoggingsh]: <https://github.com/pirate/bash-utils/blob/master/util/logging.sh> 'Bash-Utils/Util/Logging.Sh at Master · Pirate/Bash-Utils'
# [z@/BashutilsUtilLoggingsh]: <zotero://select/items/@/BashutilsUtilLoggingsh> 'Select in Zotero: Bash-Utils/Util/Logging.Sh at Master · Pirate/Bash-Utils'
